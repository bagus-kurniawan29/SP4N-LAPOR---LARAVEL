...
<body class="flex min-h-screen">
    <section class="bg-linear-to-br from-blue-600 to-blue-900 text-white mx-auto p-8 max-w-3xl hidden md:block">
        ...
        <div class="my-auto justify-center flex flex-col h-[50vh]">
            ...
            <p class="text-lg">
                Masuk sekarang untuk menyampaikan aspirasi dan pengaduan Anda secara langsung kepada Pemerintah Provinsi Nusa Tenggara Barat. Partisipasi Anda adalah kunci perbaikan layanan publik kami
            </p>
        </div>
    </section>
